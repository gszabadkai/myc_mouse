...
| **2H** | "closely tracking *Bbc3* was its known p53-independent activator, *Foxo3*" | **BUILT 2026-08-05** `fig2_departure_from_dose.R` | `collapse_module_ownership.rds$collapse_genes` + `$defs`, `interaction_results.rds`, `biogenesis_axis_developmental.rds$foxo_lanes` (since 2026-09-22; `combined_df_annotated_raw.rds` dropped 2026-09-21) |
