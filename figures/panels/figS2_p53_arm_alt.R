...
# The third class was called "the two that move", then "moves (padj < 0.05)"
# (author, 2026-08-09). Since 2026-09-21 it is named for its ROLE: a class defined
# by a threshold was the problem (author). Each of the two still carries its own
# padj on its label, and the legend marks Foxo3's as exploratory.
