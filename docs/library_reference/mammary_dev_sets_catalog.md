...
| `MG_HEVSLE_AP_GRAY_UP/_DN` | fgsea | adult | 150/150 | High- vs low-estrogen, AP lineage |
| `MG_HEVSLE_HS_GRAY_UP/_DN` | fgsea | adult | 150/150 | High- vs low-estrogen, HS lineage |
| `MG_HEVSLE_BA_GRAY_UP/_DN` | fgsea | adult | 150/150 | High- vs low-estrogen, basal lineage |
| `MG_TEB_VS_DUCTAL_AP_GRAY_UP/_DN` | fgsea | puberty | 150/150 | TEB vs ductal, AP lineage |
| `MG_TEB_VS_DUCTAL_HS_GRAY_UP/_DN` | fgsea | puberty | 150/150 | TEB vs ductal, HS lineage |
| `MG_TEB_VS_DUCTAL_BA_GRAY_UP/_DN` | fgsea | puberty | 150/150 | TEB vs ductal, basal lineage |
...
| Set | method | stage | size | Refers to |
|---|---|---|---|---|
| `MG_BASAL_PAL2017` | fgsea | adult | 200 | Basal (top-200 markers) |
| `MG_LUMINAL_PAL2017` | fgsea | adult | 200 | Luminal (top-200) |
| `MG_LP_PAL2017_CIII` | fgsea | pubertal | 15 | Luminal progenitor (CD55+) |
| `MG_LUMINAL_PAL2017_CI/CII` | fgsea | pubertal/adult | 31/23 | Luminal1 / Luminal2 |
| `MG_BASAL_PAL2017_CIV/CVI/CVII` | fgsea | mixed | 26/43/30 | Basal subclusters |
| `MG_MIXED_PAL2017_CV` | fgsea | pubertal | 57 | Mixed-lineage |
| `MG_CLUSTER_I..VI_PAL2017` | fgsea | embryonic..adult | 8-41 | Developmental timeline clusters |
...
| Set | method | stage | size | Refers to |
|---|---|---|---|---|
| `MG_BASALPRO_SAEKI` | fgsea | integrated | 230 | MaSC / basal progenitor |
| `MG_BASAL_SAEKI` | fgsea | integrated | 303 | Basal |
| `MG_LAPRO_SAEKI` | fgsea | integrated | 232 | Luminal alveolar progenitor |
| `MG_LALV_SAEKI` | fgsea | integrated | 212 | Luminal alveolar (mature) |
| `MG_LHPRO_SAEKI` | fgsea | integrated | 210 | Luminal hormone-sensing progenitor |
| `MG_LHOR_SAEKI` | fgsea | integrated | 215 | Luminal hormone-sensing (mature) |
...
### GIRADDI et al. 2018 (12 sets) - NMF signatures (gsva, large)
